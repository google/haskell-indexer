...
analyseTypechecked' ghcEnv opts modSummary renSource tcSource (mod', mspan) = do
  ...
  return $ XRef
      ...
      , xrefDecls = decls
      , xrefDocDecls = []  -- generated by GhcApiSupport
      , xrefModuleDocDecls = []  -- generated by GhcApiSupport
      , xrefCrossRefs = refs
      , xrefRelations = rels
      , xrefImports = imports
      }
...
makeInstanceTick ctx splitType = Tick
    { tickSourcePath = Just $ ecSourcePath ctx
